// __PROJECT__ - Environment Infrastructure Orchestration
//
...
// (__PROJECT__-shared-rg) and is referenced cross-RG via 'existing' resource.
...
param sharedResourceGroup string = '__PROJECT__-shared-rg'

@description('Name of the shared Azure Container Registry')
param acrName string = '__PROJECT__acr'

@description('Name of the environment resource group')
param resourceGroupName string = '__PROJECT__-${environment}-rg'
